...
<div>
    <div class="affix-container">
        ...
        <ClientOnly>
            ...
            <el-drawer class="searchDrawer" size="20%" direction="ttb" v-model="showSearch" :lock-scroll="false"  :with-header="false">
                <div class="searchDrawer-inputDiv">
                    <el-input v-model="searchData" placeholder="搜索点什么..." type="text" size="large" :prefix-icon="ElIconSearch" :suffix-icon="ElIconRight" />
                </div>
            </el-drawer>
        </ClientOnly>
        <slot />
