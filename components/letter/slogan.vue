...
<template>
    <!-- 标语盒子 -->
    <div class="selection-slogan-box">
        <div class="selection-slogan">
            <div>
                <h1 style="font-size: 48px;margin-bottom: 15px;color: #fef;">这里藏着时间的魔法</h1>
