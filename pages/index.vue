        ...
        <div style="
          ...
          <div>
            ...
            <el-config-provider size="large" :locale="zh">
              <el-pagination v-model:current-page="page.current" v-model:page-size="page.size" :small="false"
                :disabled="false" :background="true" layout="total, prev, pager, next" :hide-on-single-page="true"
                @size-change="fetchData()" @current-change="fetchData()" :total="total" style="
                  display: flex;
                  justify-content: center;
